...
bg1=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\election-2009-3h.jpg")
bg2=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\img1.png")
bg3=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\voterloginimg.jpg")
bg4=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\devcontact.jpg")
bg5=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\finalresimg.jpg")
devbg=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_teamlogo1-removebg-preview (1).png")
response=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\thankyou2.jpg")
bg6=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_lock2.jpg")
bg7=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_wp2691496-cyber-security-wallpapers.jpg")
bg8=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_s1.jpg")
bg9=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\build.jpg")
bg10=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_pexels-pixabay-459301.jpg")
bg11=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\tedy.jpg")
bg12=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_pexels-johannes-plenio-1102909.jpg")
bg13=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_graph.jpg")
bg14=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_pexels-pixabay-326055.jpg")
bg15=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_pexels-simon-berger-1266810.jpg")
bg16=ImageTk.PhotoImage(file="C:\\Users\\91883\\Documents\\mini project\\Evmpackage\\m_error.jpg")
...
def authologin():
    ...
    f3=Frame(f2)
    f3.place(x=480,y=150,height=400,width=400)
    ...
    l1=Label(f3,text='Username',font=("Copperplate Gothic Bold",15,'bold'),fg='#010413')
    l1.place(x=20,y=100)
...
def register():
    ...
    e8=Entry(f5,font=("Eras Bold ITC",14),textvariable=m)
...
def datetimeinfo():
    ...
    l1=Label(f4,text="Enter Start Time Of Electiom In (H)",font=("Franklin Gothic Heavy",16),bg='#E0B0FF')
    l1.place(x=50,y=100)
    ...
    l3=Label(f4,text="Enter Month In Which Elections will Counduct (MM)",font=("Franklin Gothic Heavy",16),bg='#E0B0FF')
    l3.place(x=50,y=320)

    e3=Entry(f4,font=("Franklin Gothic Heavy",16),textvariable=c)
    e3.place(x=70,y=370)

    l4=Label(f4,text="Enter Year In Which Elections will Counduct (YYYY)",font=("Franklin Gothic Heavy",16),bg='#E0B0FF')
    l4.place(x=50,y=450)
...
def NOTA():
    ...
    if status[0] == "NV":
        ...
        l1=Label(f7,image=response).place(x=0,y=0,relwidth=1,relheight=1)
...
def finalres():
    ...
    b1.place(x=20,y=430,height=50,width=100)
...
def devcontact():
    ...
    l1=Label(f12,text="MS. HARSHADA \n MEMANE",font=('Rockwell Extra Bold',16),fg="#f47120",bg="white")
    l1.place(x=70,y=40)

    l2=Label(f12,text="MS. GAYATRI\n GUNJAL",font=('Franklin Gothic Heavy',16),fg="#721B65",bg="white")
    l2.place(x=70,y=120)

    l3=Label(f12,text="MS. NIKITA\n KAMBLE",font=('Rockwell Extra Bold',16),fg="#0c3561",bg="white")
    l3.place(x=70,y=200)

    l1=Label(f12,text="_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*",font=('Rockwell Extra Bold',13),fg="purple",bg="white")
    l1.place(x=10,y=250)

    l4=Label(f13,text=".....SPECIAL THANKS TO.....\n\n MR. HONADE SIR",font=('Franklin Gothic Heavy',14),fg='#990012',bg="white")
    l4.place(x=30,y=60)
    ...
    b1=Button(f11,text='<-HOME',font=('Magneto',13),bg='gray',fg='white',activebackground="purple",activeforeground="red",command=home)
